...
//   // Get additional data from the first page (assuming all pages have the same structure)
//   const firstPage = data?.pages[0];
//   const postsByHash = firstPage?.PostsByHash || {};
//   const profilesByPublicKey = firstPage?.ProfilesByPublicKey || {};
